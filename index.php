  ...
  <div class="row">
    ...
    <div class="card h-100">
        <div class="card-body">
          ...
          <p class="card-text">Data nilai tentang nama mahasiswa, mata kuliah, nilai dan huruf</p>
      ...
      <div class="card h-100">
        <div class="card-body">
          ...
          <p class="card-text">Data mahasiswa berisi tentang NIM, nama, program studi, semester, kelas, tahun angkatan dan status</p>
      ...
      <div class="card h-100">
        <div class="card-body">
          ...
          <p class="card-text">Fitur pencarian untuk mencari mahasiswa</p>
